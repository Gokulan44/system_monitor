...
public final class SecuritySettingsDao_AppDatabase_Impl implements SecuritySettingsDao {
  ...
  public SecuritySettingsDao_AppDatabase_Impl(@NonNull final RoomDatabase __db) {
    this.__db = __db;
