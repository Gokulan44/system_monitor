...
public final class IntruderSelfieDao_LockDatabase_Impl implements IntruderSelfieDao {
  ...
  public IntruderSelfieDao_LockDatabase_Impl(@NonNull final RoomDatabase __db) {
    this.__db = __db;
